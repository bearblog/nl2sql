...
class BertNL2SQL(BertPreTrainedModel):
    def __init__(self, config):
        super(BertNL2SQL, self).__init__(config)
    ...
    def forward(self, input_ids, attention_mask, all_masks, header_masks, question_masks, subheader_masks, nextColumn_CLS_startPositionList, value_masks, firstColumn_CLS_startPositionList, train_dependencies=None):
