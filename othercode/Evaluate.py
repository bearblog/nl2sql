...
class Evaluate:
    ...
    def evaluate(logits_lists, firstColumn_CLS_startPositionList, labels_lists, question_list, question_tokens,
        ...
        if do_test is False:
            ...
            err_list, tot_err, ex_acc_num = Evaluate.check_acc(sql_finalPredict, sql_list_groundTruth, table_id_list)
    ...
    @staticmethod
    def check_acc(pred_queries, gt_queries, table_id_list):
        ...
        engine = DBEngine("../data/val/val.db")
        ex_acc_num = 0.0
        ...
        print("sel_num_acc is :", 1 - (sel_num_err / total_num))
        print("sel_acc is :", 1 - (sel_err / total_num))
        print("agg_acc is :", 1 - (agg_err / total_num))
        print("cond_num_acc is :", 1 - (cond_num_err / total_num))
        print("cond_col_acc is :", 1 - (cond_col_err / total_num))
        print("cond_op_acc is :", 1 - (cond_op_err / total_num))
        print("cond_val_acc is :", 1 - (cond_val_err / total_num))
        print("cond_rela_err is :", 1 - (cond_rela_err / total_num))
        print("Execution Accuracy is :", (ex_acc_num / total_num))
        print("total accuracy is :", 1 - (tot_err / total_num))
